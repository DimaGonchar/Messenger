...
public:
	UserInformation();
	explicit UserInformation(const std::uint64_t id, const std::string& login, const std::string& pass, const std::string& name);
	explicit UserInformation(const std::string& login, const std::string& pass, const std::string& name);
